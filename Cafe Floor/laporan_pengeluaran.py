...
def show_laporan_pengeluaran():
    ...
    window = tk.Toplevel()
    window.title("Laporan Pengeluaran")
    window.geometry("700x500")
    window.configure(bg="#e9fbe5")

    title = tk.Label(window, text="Laporan Pengeluaran", font=("Segoe UI", 18, "bold"), bg="#198754", fg="white", pady=15)
